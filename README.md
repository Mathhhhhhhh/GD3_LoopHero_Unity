...
>>Le mini-jeu — Le champ de l'Agriculteur:
En arrivant sur la case de l'Agriculteur, Lulu est envoyé dans un champ. Trois cloches sont disposées dans 
l'environnement. Le joueur doit les activer dans le bon ordre pour faire apparaître les carottes cachées, 
puis les collecter en s'en approchant.

Une fois les trois carottes récupérées, le mini-jeu se termine et Lulu revient automatiquement 
